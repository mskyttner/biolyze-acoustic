...
while [ 1 ] ; do
	bash /home/pi/bats/scripts/reset.sh
	export TIMESTAMP=`date +%Y%m%d_%H%M%S`
#	nice -n -20 rec -V4 --single-threaded "raw/$TIMESTAMP.raw"
	nice -n -20 rec -V --guard --single-threaded --buffer 32768 --channels 1 --rate 200k --bits 16 --encoding signed "/home/pi/bats/out/$TIMESTAMP.wav" silence 1 0.1 1% 1 0:00:02 1%
